...
- Added reusable per-component structural facts, counterexamples, and proof evidence tied to generation and wire hashes.
...
- Added nonce binding, strict bounds, conflict detection, proof-only elimination, and component-isolated refinement. State actions remain fixed.
